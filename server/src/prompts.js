...
const trainingModeProfiles = {
  constructive: {
    ...
    opening: '请在内部模拟对立方一辩陈词，但不要展示完整陈词和思考过程。只输出“对立方一辩陈词摘要”，包含：1个核心标准、3个分论点、每个分论点30-50字摘要、2条事实论据。不要给用户建议、示范稿或写作方向。',
  ...
  summary: {
    ...
    opening: '请在内部模拟前面攻辩已经发生的交锋，但不要展示思考过程。只输出“场上已有交锋点”，包含：3个具体交锋点、对立方在每个交锋点上的主张、每个主张30-50字摘要、2-3条事实论据。不要给用户小结建议或示范稿。',
  ...
  attack: {
    ...
    opening: '请在内部模拟对立方一辩陈词，但不要展示完整陈词和思考过程。只输出“对立方一辩陈词摘要”，包含：1个核心标准、3-5个可被攻辩质询的分论点、每个分论点30-50字摘要、每个分论点对应的简短事实依据。不要给用户追问方向、进攻建议、目的分析或示范问题。',
  ...
  closing: {
    ...
    opening: '请在内部模拟比赛前半程的对立方论证和交锋，但不要展示思考过程。只输出“对立方已形成的结辩素材”，包含：3个关键交锋点、对立方核心胜负判断、3个主要论点、每个论点30-50字摘要。不要给用户结辩建议、发挥战场或示范稿。',
    ...
    return [
      {
        ...
        content: [
          ...
          '输出格式：标题为“对立方一辩陈词摘要”或“对立方已提出的关键点”，下面用编号列表罗列。不要出现“你可以”“建议”“追问”等措辞。',
