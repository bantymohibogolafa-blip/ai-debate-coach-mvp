...
const trainingModeProfiles = {
  constructive: {
    ...
    opening: '请只输出正方已经提出的核心立论观点，列出2-3条主张和可引用事实论据。不要给用户指引、建议、追问方向或示范稿。',
  ...
  summary: {
    ...
    opening: '请只输出对立面已经提出的场上交锋点：列出3个主要交锋点、对方主要论点和可引用事实论据。不要给用户指引、建议、追问方向或示范稿。',
  ...
  attack: {
    ...
    opening: '请只输出对立面已经提出的观点，包含其核心标准和1-2个主要理由。不要给用户追问方向、进攻建议、目的分析或示范问题。',
  ...
  closing: {
    ...
    opening: '请只输出对立面已经提出的关键交锋点和核心胜负判断，列出其主要论点。不要给用户指引、建议、发挥战场或示范稿。',
    ...
    return [
      {
        ...
        content: [
          ...
          modeInstruction,
          '正方永远先进行，反方随后进行。',
          '开局只允许提供用户对立面已经提出的观点或场上交锋点。',
          '不要给用户指引、建议、追问方向、目的分析、发挥战场或示范稿。',
